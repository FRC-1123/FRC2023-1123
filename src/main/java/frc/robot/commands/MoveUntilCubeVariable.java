...
public class MoveUntilCubeVariable extends CommandBase {
   ...
   */
  public MoveUntilCubeVariable(DriveSubsystem drive, SensorSubsystem sensor, double maxDistance){
  ...
  public boolean isFinished() {
    ...
    if(Math.abs(currentPose.getX()) + Math.abs(currentPose.getY()) > maxDistance){
      return true;
    }
    return false;
  }
