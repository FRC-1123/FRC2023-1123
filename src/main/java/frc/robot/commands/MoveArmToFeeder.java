...
public class MoveArmToFeeder extends CommandBase {
   ...
   */
  public MoveArmToFeeder(ArmSubsystem armed, double uAP, double lAP, double wP){
  ...
  public void execute() {
    ...
    // System.out.println("upper arm median set" + upperArmMedianSet);
      ...
      if(m_armSubsystem.getUpperArmPosition() < -45){
