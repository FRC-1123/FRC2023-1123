...
public class MoveASmallDistancePidSlow extends CommandBase {
   ...
   */
  public MoveASmallDistancePidSlow(DriveSubsystem subsystem, double xDistance, double yDistance, double heading) {
