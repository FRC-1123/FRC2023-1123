...
public class custom_wheel_angleInputFast extends CommandBase {
   ...
   */
  public custom_wheel_angleInputFast(DriveSubsystem subsystem, int fRightAngle, int rRightAngle, int fLeftAngle, 
  int rLeftAngle) {
